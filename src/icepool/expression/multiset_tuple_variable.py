...
import icepool
from icepool.expression.multiset_expression_base import MultisetExpressionBase, MultisetVariableBase
...
class MultisetTupleVariable(MultisetTupleExpression, MultisetVariableBase):
